...
// // Get current round
// router.get('/:gameId/current-round', requireSameEnterprise, gameController.getCurrentRound);

// // Submit drawing
// router.post('/:gameId/drawing', requireSameEnterprise, gameController.submitDrawing);
